    ...
    <Box className="tw-absolute tw-h-full tw-overflow-y-auto sm:tw-w-fit tw-w-full tw-top-1/2 tw-left-1/2 tw-transform -tw-translate-x-1/2 -tw-translate-y-1/2">
      <div className="tw-w-full">
        <Card title="Резолюция">
          <form className="tw-px-8 tw-pt-3 tw-bg-white md:tw-rounded-lg ">
              ...
              <FormGroup key={index}>
                <div className="tw-mt-5 tw-gap-6 tw-grid tw-grid-cols-6 tw-items-center">
                  ...
                  <Autocomplete
                    ...
                    value={item?.to}
                    renderInput={(params) => (
                      <TextField {...params} label="Контакт/Группа" required />
                    )}
                  ...
                  <Autocomplete
                    ...
                    value={item.text}
                    renderInput={(params) => (
                      <TextField {...params} label="Текст резолюции" required />
                    )}
