...
import { useRejectMFAccessFormMutation } from "@services/accessMfApi";
...
export const RejectModal: FC<IRejectModal> = ({ entry, open, onClose }) => {
  // mutations
  const rejectReasonsQuery = useFetchRejectReasonsQuery({ type: 2 });
  const [rejectAccessForm] = useRejectMFAccessFormMutation();
