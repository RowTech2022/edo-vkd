...
import { RuTokenContext } from "./auth/RuToken";
import { TokenControllContext } from "./auth/TokenAuth";
import { Avatar, Tooltip } from "@mui/material";
import { useFetchModulesQuery } from "@services/modulesApi";
import { useSession } from "@hooks";
import { signOut } from "@configs";
import { CertificateContext } from "./certificate-auth";
    ...
    <div>
      <Menu as="div" className="tw-relative">
        {({ open }) => (
          <>
            <>
              <Menu.Button className="max-md:tw-hidden tw-py-2 tw-px-4 tw-flex tw-gap-4 tw-items-center tw-text-sm !hover:tw-bg-transparent">
                <Avatar
                  alt={"unkhown"}
                  src={avatar || ""}
            ...
            <Menu.Button className="md:tw-hidden tw-py-2">
              <MenuIcon />
            </Menu.Button>
